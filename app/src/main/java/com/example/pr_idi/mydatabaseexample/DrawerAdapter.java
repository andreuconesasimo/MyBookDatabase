...
public class DrawerAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (text){
            case "Home":
                id = R.drawable.ic_home_white_24dp;
                imatge.setImageResource(id);
                break;
            case "Add book":
                id = R.drawable.ic_add_circle_white_24dp;
                imatge.setImageResource(id);
                break;
            case "Remove book":
            ...
            case "Books of one author":
                id = R.drawable.ic_list_white_24dp;
                imatge.setImageResource(id);
            break;
            case "Change my evaluation":
                id = R.drawable.ic_edit_white_24dp;
                imatge.setImageResource(id);
            break;
            case "Help":
                needSeparator = true;
                id = R.drawable.ic_help_white_24dp;
                imatge.setImageResource(id);
            break;
            case "About":
                id = R.drawable.ic_info_white_24dp;
                imatge.setImageResource(id);
            break;
        }
        ...
        if(needSeparator) {
            ...
            separator.setText(titleBuffer.data, 0, 1);
